...
>
    ...
    <div x-show="show" class="mb-6 bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
        ...
        <div class="min-h-screen bg-gray-100">
            <div class="bg-white shadow max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                {{ $header ?? '' }}
            </div>
            <div class="py-4">
                <div class="sm:px-6 lg:px-8 m-4">
                    <div class="bg-white m-4 overflow-hidden shadow-xl sm:rounded-lg">
                        <div class="container">
                            <div class="m-4">
                                {{ $body ?? '' }}
                            </div>
