...
<!-- VISTA PRINCIPAL DE CLIENTES  -->
    ...
    margin-right: 26px;">
        <button wire:click="openModal" class="bg-blue-900 text-gray-200 mt-10 hover:bg-blue-400 text-white font-bold py-2 px-4 rounded-full inline-flex items-center shadow-md">
                ...
                <div class="bg-blue-900 text-gray-200 bg-opacity-75 px-4 py-3 sm:px-6 rounded-t-lg">
                    <div class="flex flex-col items-center w-full">
                        ...
                        <h3 class="text-lg leading-6 font-medium text-gray-200 text-center w-full" id="modal-title">
                            {{ ($action == 'create')?'CREAR CLIENTE': (($action == 'edit') ? 'EDITAR CLIENTE' : 'DETALLES DEL CLIENTE') }}
                        </h3>
                    </div>
                </div>
