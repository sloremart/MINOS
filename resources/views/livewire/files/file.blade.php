            ...
            <div class="bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-2xl sm:w-full z-10">
                ...
                <div class="bg-blue-900 text-gray-200 bg-opacity-75 px-4 py-3 sm:px-6 rounded-t-lg">
                    <div class="flex flex-col items-center w-full">
                        ...
                        <h3 class="text-lg leading-6 font-medium text-gray-200 text-center w-full" id="modal-title">
                            {{ ($action == 'create')?'SUBIR ARCHIVO': (($action == 'edit') ? 'EDITAR ARCHIVO' : 'DETALLES DEL ARCHIVO') }}
                        </h3>
                    </div>
                </div>
                ...
                @include("partials.v1.form.primary_form",[
                    ...
                    "form_inputs"=>[
                        ...
                        [
                            "input_type"=>"file",
                            "input_model"=>"modelForm.file",
                            "icon_class"=>"fas fa-file-upload",
                            "placeholder"=>"Seleccionar Archivo",
                            "input_field"=>"Seleccionar Archivo",
                            "col_with"=>3,
                            "required"=>true,
                        ...
                        [
                            "input_type"=>"text",
                            "input_model"=>"modelForm.file_name",
                            "icon_class"=>"fas fa-file-alt",
                            "placeholder"=>"Nombre del Archivo",
                            "input_field"=>"Nombre del Archivo",
                            "col_with"=>2,
                            "required"=>true,
                            "disabled"=>$action == 'details',
                        ],
                        [
                            "input_type"=>"text",
                            "input_model"=>"modelForm.file_type",
                            "icon_class"=>"fas fa-file-signature",
                            "placeholder"=>"Tipo de Archivo",
                            "input_field"=>"Tipo de Archivo",
                            "col_with"=>1,
                            "required"=>true,
                            "disabled"=>$action == 'details',
                        ],
                        [
                            "input_type"=>"text",
                            "input_model"=>"modelForm.file_size",
                            "icon_class"=>"fas fa-file-medical-alt",
                            "placeholder"=>"Tamaño del Archivo",
                            "input_field"=>"Tamaño del Archivo",
                            "col_with"=>1,
                            "required"=>true,
                            "disabled"=>$action == 'details',
                        ]
