<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 py-10">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 pt-2  sm:px-6 lg:px-8 bg-gray-0 rounded-full shadow-lg">
            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:flex-col sm:space-y-2 sm:ms-10">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        <div class="flex flex-col items-center">
                            <img src="{{ asset('img/Iconos_Menu/INICIO/INICIO.png') }}" alt="aca va el icono" class="w-10 h-auto pb-2.5">
                            <span>{{ __('Inicio') }}</span>
                        </div>
                    </x-nav-link>
                </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:flex-col sm:space-y-2 sm:ms-10">
                    <x-nav-link href="{{ route('tablas.tablas') }}" :active="request()->routeIs('tablas.tablas')">
                        <div class="flex flex-col items-center">
                            <img src="{{ asset('img/Iconos_Menu/ADMINISTRACION/ADMINISTRACION.png') }}" alt="aca va el icono" class="w-10 h-auto pb-2.5">
                            {{ __('Administacion') }}
                        </div>
                    </x-nav-link>
                </div>
