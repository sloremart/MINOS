        ...
        <ul>
            @if(!Auth::check())
                <li>
                    <a class="nav-link scrollto active" href="/">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="fas fa-tachometer-alt"
                                 viewBox="0 0 16 16">
            ...
            <li>
                <a class="nav-link scrollto" href="/">
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-file-earmark-post-fill"
                             viewBox="0 0 16 16">
                            <path
            ...
            <li>
                <a class="nav-link scrollto" href="#">
                    <i>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-cash-coin"
                             viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
