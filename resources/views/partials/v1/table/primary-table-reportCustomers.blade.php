<div>
                    ...
                    <tbody class="text-gray-700 text-sm font-light">
                        ...
                        <tr class="border-b hover:bg-blue-100">
                            ...
                            <td class="px-4 py-2 border-b">
                                ...
                                @elseif($table_header === 'total_amount')
    ...
    <script>
        document.getElementById('exportPdfBtn').addEventListener('click', function(e) {
            ...
            let url = '{{ route('reporte_clientes.list') }}' + '?search=' + encodeURIComponent(search) + '&search_1=' + encodeURIComponent(search_1) + '&search_2=' + encodeURIComponent(search_2);
