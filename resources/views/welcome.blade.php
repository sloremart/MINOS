    ...
    <div class="wave-container">
        <div class="content">
            ...
            <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen selection:bg-red-500 selection:text-white">
                ...
                <div class="max-w-7xl -mt-14 p-6 lg:p-8">
                    ...
                    <div class="mt-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            <div class="scale-100  bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500" style="background-image: url({{asset('images/Welcome_img/Portada3.jpg')}}); background-repeat: no-repeat; background-size: cover; background-position: center; width: 100%; height: auto;">
